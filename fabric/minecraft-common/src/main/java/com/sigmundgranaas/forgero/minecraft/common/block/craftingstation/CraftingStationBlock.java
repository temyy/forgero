...
public class CraftingStationBlock extends Block{
	...
	public static final BlockItem CRAFTING_STATION_ITEM = new BlockItem(CRAFTING_STATION_BLOCK, new Item.Settings().group(ItemGroup.MISC));
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory((syncId, inventory, player) -> new CraftingStationScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), Text.literal("crafting_station"));
	}
